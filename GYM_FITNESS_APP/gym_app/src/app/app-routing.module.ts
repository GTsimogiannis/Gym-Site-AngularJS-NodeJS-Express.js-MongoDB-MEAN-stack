...
import { DietPageComponent2 } from './home_page/diet-page2/diet-page2.component';
import { DietPageComponent3 } from './home_page/diet-page3/diet-page3.component';
...
const routes: Routes = [
  ...
  { path: 'lowcaloriediet', component: DietPageComponent, canActivate: [AuthGuard] },
  { path: 'normaldiet', component: DietPageComponent2, canActivate: [AuthGuard] },
  { path: 'proteindiet', component: DietPageComponent3, canActivate: [AuthGuard] },
